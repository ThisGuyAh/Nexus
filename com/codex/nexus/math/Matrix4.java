...
public class Matrix4 {
	...
	public Matrix4 setTransformation(Vector3 translation, Vector3 rotation, Vector3 scale) {
		...
		rotate((float) Math.toRadians(rotation.x), new Vector3(1.0F, 0.0F, 0.0F));
		rotate((float) Math.toRadians(rotation.y), new Vector3(0.0F, 1.0F, 0.0F));
		rotate((float) Math.toRadians(rotation.z), new Vector3(0.0F, 0.0F, 1.0F));
		scale(scale);
	...
	public Matrix4 setProjection(float aspectRatio, float fieldOfView, float nearPlane, float farPlane) {
